 ...
 * @abstract
 */
function MRedis(model, config) {
    MStore.call(this, model, config);
}

$util.inherits(MRedis, MStore);

module.exports = exports = MRedis;

/**
 * @api private
 */
MRedis.prototype.init = function() {
 ...
 * @sync
 */
MRedis.prototype.change = function(config, fn) {
 ...
 * @param fn
 */
MRedis.prototype.close = function(fn) {
    // 关闭
    if(!$util.isEmpty(this.link)) {
        this.link.close();
    }
 ...
 * @api private
 */
MRedis.prototype.connect = function(fn) {
    var link = this.link;
 ...
 * @param fn
 */
MRedis.prototype.set = function(key, obj, fn, lifetime) {
    var me = this;
 ...
 * @param fn
 */
MRedis.prototype.get = function(key, fn) {
    var me = this;
    var columns = this.model.columns();
    var table = this.model.table();
    var link = this.link;
 ...
 * @param fn
 */
MRedis.prototype.del = function(key, fn) {
    var me = this;
    var link = this.link;
    var table = this.model.table();
    // 连接
