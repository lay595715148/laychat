...
Token.prototype.post = function() {
    ...
    var checkClient = function(ret) {
        if(ret) {$logger.info(request_type, code, username, password, refresh_token);
     ...
     * 检测请求参数
     */
    var checked = oservice.checkRequest(scope, request_type);$logger.info('request_type', request_type);
