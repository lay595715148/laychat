...
Template.factory = function(classname) {
    ...
    if(Utilities.isA(Template.instances[classname], Template)) {
        instance = Template.instances[classname];
    } else {
        var SubClass = require('../template/' + classname);
        instance = Template.instances[classname] = Utilities.construct(SubClass, args);
    }
    return instance;
};
/**
