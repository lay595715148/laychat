...
Action.prototype.onCreate = function() {
    $logger.info('Action ' + $util.getClass(this) + ' onCreate');
    this.emit('start');
};
/**
 * @protected
...
Action.prototype.onStart = function() {
    $logger.info('Action ' + $util.getClass(this) + ' onStart');
    this.emit('request');
};
/**
 * @protected
...
Action.prototype.onRequest = function() {
    $logger.info('Action ' + $util.getClass(this) + ' onRequest');
...
Action.prototype.onGet = function() {
    $logger.info('Action ' + $util.getClass(this) + ' onGet');
    this.emit('stop');
};
/**
 * @protected
...
Action.prototype.onPost = function() {
    $logger.info('Action ' + $util.getClass(this) + ' onPost');
    this.emit('stop');
};
/**
 * @protected
...
Action.prototype.onStop = function() {
    $logger.info('Action ' + $util.getClass(this) + ' onStop');
    this.emit('destroy');
};
/**
 * @protected
...
Action.prototype.onDestroy = function() {
    $logger.info('Action ' + $util.getClass(this) + ' onDestroy');
};
