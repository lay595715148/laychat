        ...
        if($util.isArray(regexps)) {
            for(var i in regexps) {
                ...
                if(matchs) {
                    ...
                    Laychat.openAction(ref, req, res);
...
Laychat.openAction = function(name, req, res) {
    var action = Action.instance(name, req, res);
    action.on('create', function() {
        action.onCreate();
    }).on('start', function() {
        action.onStart();
    }).on('get', function() {
