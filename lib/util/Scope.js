...
Scope.prototype.token = function(request) {
    return this.resolve(false, request)[Scope.TOKEN];
};
/**
 * @api private
 * @param request
...
Scope.prototype.resolve = function(reset, request) {
    ...
    this.chunks = [_get, _post, _request, _cookie, _session, _param, _header, _user, _token];
